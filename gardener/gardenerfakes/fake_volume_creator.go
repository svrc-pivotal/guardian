...
type FakeVolumeCreator struct {
	...
	DestroyStub        func(log lager.Logger, handle string, privileged bool) error
...
func (fake *FakeVolumeCreator) Destroy(log lager.Logger, handle string, privileged bool) error {
	...
	fake.recordInvocation("Destroy", []interface{}{log, handle, privileged})
	fake.destroyMutex.Unlock()
	if fake.DestroyStub != nil {
		return fake.DestroyStub(log, handle, privileged)
	} else {
...
func (fake *FakeVolumeCreator) DestroyArgsForCall(i int) (lager.Logger, string, bool) {
	fake.destroyMutex.RLock()
	defer fake.destroyMutex.RUnlock()
	return fake.destroyArgsForCall[i].log, fake.destroyArgsForCall[i].handle, fake.destroyArgsForCall[i].privileged
}
