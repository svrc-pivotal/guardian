...
func NewGardenRunner(bin, initBin, nstarBin, dadooBin, grootfsBin, rootfs, tarBin, imagePluginBin, network, address string, argv ...string) GardenRunner {
	r := GardenRunner{}
	...
	r.Cmd = cmd(r.TmpDir, r.DepotDir, r.GraphPath, r.Network, r.Addr, bin, initBin, nstarBin, dadooBin, grootfsBin, tarBin, imagePluginBin, rootfs, argv...)
...
func Start(bin, initBin, nstarBin, dadooBin, grootfsBin, rootfs, tarBin, imagePluginBin string, argv ...string) *RunningGarden {
	runner := NewGardenRunner(bin, initBin, nstarBin, dadooBin, grootfsBin, rootfs, tarBin, imagePluginBin, "unix", fmt.Sprintf("/tmp/garden_%d.sock", GinkgoParallelNode()), argv...)
...
func cmd(tmpdir, depotDir, graphPath, network, addr, bin, initBin, nstarBin, dadooBin, grootfsBin, tarBin, imagePluginBin, rootfs string, argv ...string) *exec.Cmd {
	...
	gardenArgs = appendDefaultFlag(gardenArgs, "--image-plugin", imagePluginBin)
